...
describe('✅ getSLD()', () => {
    ...
    it('should return SLD for a valid URL', () => {
        expect(FN('https://sub.example.com/path')).toBe('example');
    });
    it('should return SLD for a URL without subdomain', () => {
        expect(FN('https://example.com/path')).toBe('example');
    });
    it('should return SLD for a URL with multiple subdomains', () => {
        expect(FN('https://sub.sub2.example.co.uk/path')).toBe('co');
    });
    it('should return empty string for invalid URL', () => {
        expect(FN('invalid-url')).toBe('');
    });
    it('should return empty string for URL without domain', () => {
        expect(FN('https:///path')).toBe('');
    });
});
